...
export default function AddModalExport({ closeModal, title, titleBtnFooter, handleAddExportInvoice }) {
  ...
  const onSubmit = () => {
    try {
      ...
      handleAddExportInvoice({ products: newData, createdBy: createdBy, searchName: stringNameProducts });
    } catch (error) {
      console.log(error);
    }
  };
