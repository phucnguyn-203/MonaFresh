export default function IconExcel() {
  return (
    <svg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg" fill="#0f773d" stroke="#0f773d" strokeWidth="3.6">
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g id="xxx-word">
          {" "}
          <path className="cls-1" d="M325,105H250a5,5,0,0,1-5-5V25a5,5,0,1,1,10,0V95h70a5,5,0,0,1,0,10Z"></path>{" "}
          <path
            className="cls-1"
          ...
          ></path>{" "}
          <path className="cls-1" d="M275,280H125a5,5,0,1,1,0-10H275a5,5,0,0,1,0,10Z"></path>{" "}
          <path className="cls-1" d="M200,330H125a5,5,0,1,1,0-10h75a5,5,0,0,1,0,10Z"></path>{" "}
          <path
            className="cls-1"
          ...
          ></path>{" "}
          <path className="cls-1" d="M152.44,236H117.79V182.68h34.3v7.93H127.4v14.45h19.84v7.73H127.4v14.92h25Z"></path>{" "}
          <path
            className="cls-1"
          ...
          ></path>{" "}
          <path className="cls-1" d="M282.71,236h-8.91V182.68h8.91Z"></path>{" "}
        </g>{" "}
      </g>
    </svg>
  );
