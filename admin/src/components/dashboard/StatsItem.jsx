export function StatsItem({ icon, title, value, backgroundColor }) {
  return (
    ...
    >
      ...
      <div className="mt-2">
        <p className="text-base mb-3 font-medium text-gray-50 dark:text-gray-100 uppercase">{title}</p>
        <p className="text-3xl font-bold leading-none text-gray-50 dark:text-gray-50 p-2">{value}</p>
      </div>
    </div>
  );
}
