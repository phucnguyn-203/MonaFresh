...
import { IconFacebook, IconInstagram, IconAddress, IconEmail, IconPhone } from "../../icons";
    ...
    return (
        <footer className={`${styles.footer} text-white`}>
            <div className="container flex gap-x-6 py-[80px] flex-1">
                ...
                <div className="w-1/4 ">
                    ...
                    <div className="text-[#A4A4A4A4] px-[15px]">
                        <p className="py-[6px]">Đăng ký để nhận được được thông tin mới nhất từ chúng tôi.</p>
                        <input
                            type="text"
                            placeholder="Email"
            ...
            <div className="text-center bg-[#000000] py-[15px] text-[#FFFFFF80]">
                <p>&copy; Bản quyền website thuộc nhóm 9 D21CQAT01-N</p>
            </div>
        </footer>
    );
}
