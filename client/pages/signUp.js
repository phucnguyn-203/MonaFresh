...
function SignUp() {
    const schema = yup.object().shape({
        ...
        email: yup
            ...
            .email("Vui lòng nhập Email đăng ký đúng định dạng của Email"),
        phone: yup.string().required("Vui lòng nhập số điện thoại").phone("Vui lòng nhập đúng định dạng số điện thoại"),
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="max-w-[400px] w-full mx-auto rounded-lg  p-8 px-9 ">
            <h2 className="text-4xl dark:text-white font-bold text-center font-serif text-teal-700">ĐĂNG KÝ</h2>
            ...
            <div className="flex flex-col text-teal-800 py-2">
                ...
                <input
                    ...
                    {...register("phone")}
                />
                {errors.phone && <p className="text-red-500 text-sm italic">{`*${errors.phone.message}`}</p>}
            </div>
            <div className="flex flex-col text-teal-800 py-2">
            ...
            <div className="flex flex-col text-teal-800 py-2">
                ...
                <input
                    ...
                    {...register("cpassword")}
                />
                {errors.cpassword && <p className="text-red-500 text-sm italic">{`*${errors.cpassword.message}`}</p>}
            </div>
